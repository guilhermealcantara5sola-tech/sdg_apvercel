  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-10">
      <div className="flex items-center gap-3">
        ...
        {/* Search bar hidden on extra small viewports */}
        <div className="relative w-48 sm:w-96 hidden xs:block">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button className="flex items-center gap-2 hover:bg-gray-100 p-1 sm:pr-3 rounded-full transition-colors">
          <div className="w-8 h-8 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 rounded-full flex items-center justify-center text-white p-0.5 shrink-0">
          ...
          <span className="text-sm font-medium text-gray-700 hidden sm:inline">meu_perfil</span>
        </button>
      </div>
    </header>
  );
